...
// 管理员设置相关函数
function openCloudPasswordManager() {
    window.open('easy-password-manager.html', '_blank');
}

function openAdminSettings() {
    window.open('simple-admin.html', '_blank');
}



function openPasswordSetup() {
    window.open('password-setup.html', '_blank');
}
